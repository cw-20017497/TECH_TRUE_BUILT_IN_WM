...
{
    U32 TimerBlink[ MAX_DISP_TIMER_BLINK_ID ];
    U32 TimerCount[ MAX_DISP_TIMER_BLINK_ID ];
...
U8 IsExpiredDispBlinkTimer(U8 id)
{
    ...
    if( DispTimer.TimerBlink[ id ] == 0UL )
    {
        return TRUE;
    }
